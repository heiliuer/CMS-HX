...
<body>
	...
	<div id="main">
		<div id="cpi">
			<div class="cptitle">
				<a href="page/html/company.php"
					style="position: absolute; right: 10px; top: 20px;"><img
					src="./img/more.gif" style=""></a>
			</div>
		...
		<div id="newsli">
			<div class="newTitle">
				<a href="page/html/company.php"
					style="position: absolute; right: 10px; top: 0px;"><img
					src="./img/more.gif" style=""></a>
			</div>
			<ul class="listBox">
				<%
				...
				%>
				<li><a
					href="NewsServlet?action=selectNewsShow&newsClassId=19&newsid=<%=news.getId()%>"><%=news.getTitle()%></a>
					<span class="datetime"><%=news.getCreateTime()%></span></li>
				<%
					}
				%>
			</ul>
