	...
	<div id="main">
		...
		<div id="rightList">
			<div id="path">
				...
				<%=request.getAttribute("thisSortName")%></div>
			<ul id="listBox">
				<%
				...
				%>
				<li><a
					href="NewsServlet?action=selectNewsShow&newsClassId=<%=request.getParameter("newsClassId")%>&newsid=<%=news.getId()%>"><%=news.getTitle()%></a>
